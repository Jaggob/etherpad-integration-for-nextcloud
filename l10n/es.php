...
$TRANSLATIONS = [
	...
	"Add trusted Etherpad hostnames or https origins. Leave empty only if all public HTTPS hosts should be trusted." => "Agrega nombres de host de Etherpad u origenes https de confianza. Deja vacio solo si se deben confiar todos los hosts HTTPS publicos.",
