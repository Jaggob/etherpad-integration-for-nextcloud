...
$TRANSLATIONS = [
	...
	"Copy content to .pad file interval (seconds)" => "Intervalle de copie du contenu vers le fichier .pad (secondes)",
	...
	"Delete pad on trash" => "Supprimer le pad lors de la mise a la corbeille",
	"If enabled, moving a .pad file to trash triggers Etherpad delete." => "Si active, le deplacement d'un fichier .pad vers la corbeille declenche la suppression dans Etherpad.",
	...
	"Add trusted Etherpad hostnames or https origins. Leave empty only if all public HTTPS hosts should be trusted." => "Ajoutez des noms d'hote Etherpad ou des origines https de confiance. Ne laissez vide que si tous les hotes HTTPS publics doivent etre consideres comme fiables.",
	"Save settings" => "Enregistrer les parametres",
	"Health check" => "Verification de sante",
	"Consistency check" => "Verification de coherence",
	"Retry deferred deletes now" => "Relancer maintenant les suppressions differees",
	"Pending Etherpad deletes" => "Suppressions Etherpad en attente",
	"Trashed bindings without file" => "Liaisons en corbeille sans fichier",
	...
	"Checking sync status..." => "Verification de l'etat de synchronisation...",
	...
	"Lifecycle delete retry finished." => "Nouvelle tentative de suppression du cycle de vie terminee.",
	...
	"Lifecycle delete retry failed." => "La nouvelle tentative de suppression du cycle de vie a echoue.",
	"Pending delete retry failed." => "La nouvelle tentative des suppressions en attente a echoue.",
	"Failed to save settings." => "Impossible d'enregistrer les parametres.",
	...
	"Hint: In Etherpad settings.json set \"authenticationMethod\": \"apikey\"." => "Indice : dans le fichier settings.json d'Etherpad, definir \"authenticationMethod\": \"apikey\".",
	...
	"New pad" => "Nouveau pad",
	"New Pad" => "Nouveau pad",
	"External pad" => "Pad externe",
	"External pad URL" => "URL du pad externe",
	"File name" => "Nom de fichier",
	"Public pad" => "Pad public",
	"Create public pad" => "Creer un pad public",
	"Choose how you want to create the public pad." => "Choisissez comment vous souhaitez creer le pad public.",
	"Internal public pad" => "Pad public interne",
	"External public pad (URL)" => "Pad public externe (URL)",
	"Could not create public pad." => "Impossible de creer le pad public.",
	...
	"Externes Pad" => "Pad externe",
	"Open in Etherpad" => "Ouvrir dans Etherpad",
	"Open original pad" => "Ouvrir le pad d'origine",
	"Open in new tab" => "Ouvrir dans un nouvel onglet",
	"Pad in neuem Tab öffnen" => "Ouvrir le pad dans un nouvel onglet",
	"Sync now" => "Synchroniser maintenant",
	"Save pad to file" => "Enregistrer le pad dans le fichier",
	"Pad in Datei speichern" => "Enregistrer le pad dans le fichier",
	"Synchronized" => "Synchronise",
	"Sync pending" => "Synchronisation en attente",
	"Sync failed" => "Echec de la synchronisation",
	"Sync status unavailable" => "Etat de synchronisation indisponible",
	"Sync status: syncing" => "Etat de synchronisation : synchronisation...",
	"Sync status: synced" => "Etat de synchronisation : synchronise",
	"Sync status: error" => "Etat de synchronisation : erreur",
	"Sync status: pending" => "Etat de synchronisation : en attente",
	"Sync status: unavailable" => "Etat de synchronisation : indisponible",
];
